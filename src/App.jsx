          ...
          <div>
            ...
            <div style={{marginTop:12}}>
              ...
              <div style={{display:'flex', gap:8, alignItems:'center'}}>
                <input className="input" value={defaultTaxPct} onChange={e=>setDefaultTaxPct(asNumber(e.target.value,0))} />
                <button className="btn gray" onClick={applyDefaultTax}>Apply to All Lines</button>
              </div>
            </div>
